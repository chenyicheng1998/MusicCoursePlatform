...
| Booking System | Book a lesson, view/cancel bookings |
...
**Status:** COMPLETE — 228 tests pass

| Test Class | Layer | Tests |
|---|---|---|
| `UserDAOTest` | DAO | 12 |
| `BookingDAOTest` | DAO | 8 |
| `TimeSlotDAOTest` | DAO | 10 |
| `LearnerProfileDAOTest` | DAO | 9 |
| `TeacherProfileDAOTest` | DAO | 11 |
| `UserServiceTest` | Service | 14 |
| `BookingServiceTest` | Service | 13 |
| `TeacherServiceTest` | Service | 12 |
| `TimeSlotServiceTest` | Service | 10 |
| `ModelTest` | Model | 25 |
| `PasswordUtilTest` | Util | 8 |
| `SessionManagerTest` | Controller | 15 |
| `LoginControllerTest` | Controller | 18 |
| `SignupControllerTest` | Controller | 20 |
| `StudentDashboardControllerTest` | Controller | 16 |
| `TeacherDashboardControllerTest` | Controller | 14 |
| `BookingViewControllerTest` | Controller | 12 |
| `TeacherProfileViewControllerTest` | Controller | 11 |
| **Total** | | **228** |

**Pass/Fail Criteria:** All 228 tests must pass with 0 failures. Build is considered failing if any test fails.
...
**Method:** Each team member independently evaluates the application using Nielsen's 10 Usability Heuristics.  
**Severity Scale:** 0 = not a problem, 1 = cosmetic, 2 = minor, 3 = major, 4 = catastrophe  
**Output:** Individual evaluation reports + team summary table (see Heuristic_Evaluation_Sprint7.md)
...
**Accept criteria:**  
- Average response time < 2 seconds under 10 concurrent users  
- Error rate < 5%

*See JMeter_Performance_Testing_Guide.md for setup and results.*
...
### Exit Criteria
- All 228 unit tests pass with 0 failures
