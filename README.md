...
**Dockerfile Overview:** Based on Eclipse Temurin JDK 21, includes JavaFX dependencies and X11 support for GUI rendering.
...
**SonarQube Metrics:**
- Quality Gate: Passed
- Code smells: Addressed critical issues
- Security: No critical vulnerabilities
- Maintainability: Reduced complexity and duplications
